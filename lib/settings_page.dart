  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: Row(
        ...
        children: [
          if (isDesktop) AppSidebar(role: widget.role, currentPage: 'settings'),
          Expanded(
            child: ListView(
              ...
              children: [
                ...
                if (widget.role == 'admin' || widget.role == 'super-admin') ...[
                  ...
                  _buildSettingTile(
                    ...
                    onTap: () {
                      Navigator.push(
                        context,
                        MaterialPageRoute(builder: (context) => ShopLocationPage(role: widget.role)),
                      );
                    },
                  ),
                ],
                ...
                ElevatedButton(
                  ...
                  style: ElevatedButton.styleFrom(
                    backgroundColor: isDarkMode ? Colors.red[900]!.withValues(alpha: 0.2) : Colors.red[50],
    ...
    return Container(
      ...
      child: ListTile(
        ...
        leading: Container(
          ...
          child: Icon(icon, color: isDark ? Colors.white : const Color(0xFF121212), size: 20),
        ),
        title: Text(
          title,
